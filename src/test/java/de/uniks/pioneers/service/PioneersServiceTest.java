...
public class PioneersServiceTest {
    ...
    public void findAllTiles() {
        when(pioneersService.findAllTiles(any()))
                .thenReturn(Observable.just(new Map("1", List.of(new Tile(1, 2, 3, "desert", 7)))));
    ...
    public void findAllPlayers() {
        ...
        when(pioneersService.findAllPlayers(any()))
                .thenReturn(Observable.just(List.of(new Player("2", "12", Color.BLACK.toString(),
                        3, resources, remainingBuildings))));
    ...
    public void findOnePlayer() {
        ...
        when(pioneersService.findOnePlayer(any(), any()))
                .thenReturn(Observable.just(new Player("2", "12", Color.BLACK.toString(),
                        3, resources, remainingBuildings)));
    ...
    public void findOneState() {
        ...
        when(pioneersService.findOneState(any()))
                .thenReturn(Observable.just(new State("1", "12", expectedMoves)));
    ...
    public void moveBuild() {
        ...
        assertEquals(result._id(), "4");
        assertEquals(result.createdAt(), "10");
        ...
        verify(pioneersApiService).create("100", new CreateMoveDto("build",
    ...
    public void moveRoll() {
        ...
        verify(pioneersApiService).create("100", new CreateMoveDto("roll", null));
    }
}
